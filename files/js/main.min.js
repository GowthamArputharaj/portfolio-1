		...
		if (close) {
			anime({
				...
				complete: () => {
					...
					// $(".nav-wrapper .logo-icon").attr('data-lazysrc', 'files/imgs/iconn.png');
					$(".nav-wrapper .logo-icon").attr('src', 'files/imgs/iconn.png');
			...
			// $(".nav-wrapper .logo-icon").attr('data-lazysrc', 'files/imgs/iconn1.png');
			$(".nav-wrapper .logo-icon").attr('src', 'files/imgs/iconn1.png');
